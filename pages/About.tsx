...
const About: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <header className="relative pt-48 pb-56 text-center text-white rounded-bl-[5rem] rounded-br-[5rem] overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Reveal delay={0.1} className="h-full">
              <div className="float-card glass-card p-10 rounded-[40px] shadow-2xl border border-slate-200 dark:border-slate-700 h-full">
      ...
      {/* Journey Timeline */}
      <section className="py-32 bg-white dark:bg-slate-950 rounded-t-[5rem]">
        <div className="container mx-auto px-6 lg:px-24">
          <Reveal width="100%">
